     ...
     <div className="navbar bg-white-100 max-w-7xl mx-auto">
      <div className="navbar-start">
        ...
        <a className="btn btn-ghost text-xl">
          {" "}
          <FaBasketShopping className="text-sky-800 w-9 h-9" />{" "}
          <span className="text-2xl ml-2 font-bold text-sky-800">
            WhereIsIt
          </span>
        </a>
      </div>
        ...
        <ul className="menu menu-horizontal px-1 space-x-3">
          <li>
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                isActive
                  ? "border-b-2 rounded-none text-sky-800 font-semibold text-[15px] shadow-none outline-none focus:shadow-none focus:outline-none"
        ...
        {user ? (
          <div>
            ...
            <Link
              ...
              className="btn btn-outline btn-primary text-sky-800 border-sky-800 border-2 text-[15px] hover:bg-white shadow-none"
            >
              Logout
            </Link>
          </div>
          ...
          <Link to="/login" className="">
            <button className=" btn text-sky-800 border-sky-800 border-2 text-[15px] shadow-none outline-none focus:shadow-none focus:outline-none">
              Login
            </button>
          </Link>
        )}
