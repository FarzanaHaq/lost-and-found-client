  ...
  return (
    <div className="max-w-6xl mx-auto flex items-center mb-20">
      <div className="flex-1/2 px-10">
        ...
        <h1 className="text-[20px] font-bold letter-primary ">
          Reuniting People with What Matters Most
        </h1>
        <p className="text-gray-500 font-semibold mt-6 text-sm/6">
        ...
        <Link to={"/register"}>
          {" "}
          <button className="bg-[#1EA69A] px-5 py-2 mt-5 font-medium text-white">
            Join us
          </button>
        </Link>
      </div>
