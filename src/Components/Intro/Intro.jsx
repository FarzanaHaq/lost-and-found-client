...
const Intro = () => {
  return (
    <div className="lg:mb-20 mt-6 relative h-[1300px] lg:h-[800px]">
      <div className="absolute top-10  bg-[#D8E9E7] lg:w-[700px] lg:pl-30 py-10 lg:py-20 px-5">
      ...
      <div className="pl-2">
        <img
          className="max-w-[345px] h-[200px] absolute z-10 top-200 lg:right-100 lg:top-100"
        ...
        />
        <img
          className="max-w-[345px] h-[200px] absolute z-10 top-255 lg:right-10 lg:top-100"
